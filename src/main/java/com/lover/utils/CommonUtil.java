...
public class CommonUtil {
	 ...
	 * @return
	 */
	public static boolean nowBetweenTwoDates(Date begin, Date end) {
	...
	public static String generateOrderNo() {
		return format("yyyyMMddHHmmssSSS", new Date()) + getFourRandom();
	}
	...
	public static String getThisSeasonTime(int year, int month) {
		String quarter = "";
		int thisModthDays = CommonUtil.getDaysNumByMonth(year, month);
		if (month >= 1 && month <= 3) {
	...
	public static boolean isDatePassed(String catchDateString) {
		...
		Date todayBegin = CommonUtil.getDayBegin(new Date());
